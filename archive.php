...
?>
  ...
  <div class="ArchivePageBannerImage pt-md-5">
    <style>
      .inner-banner {
        background: url(<?php if(get_theme_mod('ArchivePageBannerBgImage') !='') {
          echo wp_get_attachment_url(get_theme_mod('ArchivePageBannerBgImage'));
        }

        if(wp_get_attachment_url(get_theme_mod('ArchivePageBannerBgImage'))=='') {
